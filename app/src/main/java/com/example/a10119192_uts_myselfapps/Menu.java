...
import com.example.a10119192_uts_myselfapps.dailyactivity.Daily;
import com.example.a10119192_uts_myselfapps.dailyactivity.Daily_Adapter;
import com.example.a10119192_uts_myselfapps.dailyactivity.Daily_Data;
import com.example.a10119192_uts_myselfapps.dailyactivity.Friendlist_Adapter;
import com.example.a10119192_uts_myselfapps.dailyactivity.Friends;
import com.example.a10119192_uts_myselfapps.dailyactivity.Friends_Data;
import com.example.a10119192_uts_myselfapps.gallery.Gallery_Adapter;
import com.example.a10119192_uts_myselfapps.gallery.Gallery_Item;
import com.example.a10119192_uts_myselfapps.music.Music_Adapter;
import com.example.a10119192_uts_myselfapps.music.Music_Data;
import com.example.a10119192_uts_myselfapps.music.Music_Item;
...
public class Menu extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        facebook.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                gotolink("https://www.facebook.com/fikriakbari.karim");
            }
        });
        ...
        instagram.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                gotolink("https://www.instagram.com/Fikriakbari_k/");
            }
        });
        ...
        navigation.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                gotolink("https://www.google.co.id/maps/@-6.9092774,107.6441471,19.36z?hl=id");
            }
        });
